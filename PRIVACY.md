...
This GitHub edition uses Google Play services location APIs when they are available on the device.
...
This GitHub edition may query the **GitHub Releases API** for this repository to offer in-app updates, and may download an APK you choose to install.

The separate `foss` branch can produce an F-Droid build that disables this path.
